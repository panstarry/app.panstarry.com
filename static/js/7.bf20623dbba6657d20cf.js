...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_bottom_nav_vue__ = __webpack_require__(311);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_echarts_lib_chart_themeRiver__ = __webpack_require__(211);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted() {
    $.Dlg.confirm("是否授权微信登录？", () => {
      this.sendMsg(() => {
        this.closeWx();
      });
    }, () => {
      $.Dlg.error("授权登录失败，请重试");
      this.closeWx();
    });
  },
  methods: {
    ...
    sendMsg(callback) {
      ...
      if (code && uid) {
        ...
        $.Req.service($.SvName.LOGIN_SOCKET_MSG_SEND, args, () => {
          if (callback) {
            callback();
          }
        });
...
var update = __webpack_require__(767)("326546b2", content, true, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(767)("18606c30", content, true, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(767)("a1697796", content, true, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(767)("10178f87", content, true, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(767)("777cddbc", content, true, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(767)("00a523be", content, true, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(767)("a2584b40", content, true, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(767)("edbfcdfa", content, true, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(767)("49cf833e", content, true, {});
