...
const SvName = {
  ...
  MEMBER_CARD_PAYMENT_DRAFT_DELETE: "memberCardPaymentDraftDelete",
  ...
  MEMBER_POINTS_RANK_FOR_MEMBER: "memberPointsRankForMember",
  ...
  PC_LESSON_COUNT_STAT: "pcLessonCountStat",
  MCP_WORD_CONTRACT_CREATE: "mcpWordContractCreate",
  MCP_WORD_EMPTY_CONTRACT_VIEW: "mcpWordEmptyContractView",
  GC_COACH_STAT: "gcCoachStat",
  ...
  LOGIN_SOCKET_MSG_SEND: "loginSocketMsgSend"
};
...
const Dict = {
  ...
  RoleFunc: {
    ...
    STAT_REPORT: { value: 28, name: "营业额统计" },
  ...
  staffDefineMenuList: [{ id: undefined, name: "--空--" }, { id: -1, name: "目录" },
  // {
  //   id: 101,
  //   name: "首页",
  //   icon: "iconshouyeicon",
  ...
  // },
  {
    ...
    menu: "group-lesson-table"
  }, {
    id: 11,
    name: "门店私教排课",
    icon: "iconsijiaopaike",
    link: "private-course-schedules",
    menu: "private-course-schedules"
  }, {
    id: 12,
    name: "门店私教课表",
    ...
    menu: "shop-entry-checkins",
    roleFunc: 51
  }, {
    id: 17,
    name: "统计报表",
    icon: "icontongjibaobiao1",
    link: "stat-home",
    menu: "stat"
  }, {
    id: 18,
    ...
    menu: "member-score-test-rank"
  }, {
    id: 20,
    name: "微商城",
    icon: "iconweishangcheng",
    link: "mall/product-list",
    menu: "mall/product-list"
  }, {
    id: 21,
    name: "心率排行榜",
    icon: "iconceshipaihangbang",
    link: "member-heart-rate-rank",
    menu: "member-heart-rate-rank",
    roleFunc: 93
  }, {
    id: 22,
    name: "海报制作",
    ...
    menu: "member-draft-query",
    roleFunc: 70
  }, {
    id: 29,
    name: "会员统计",
    icon: "iconhuiyuantongji1",
    link: "shop-stat-member",
    ...
    name: "员工业绩统计",
    icon: "iconyeji",
    link: "shop-stat-staff",
    menu: "shop-stat-staff",
    roleFunc: 70
  }, {
    id: 31,
    name: "课程统计",
    icon: "iconkechengtongji-",
    link: "shop-stat-course",
    ...
    id: 33,
    name: "收支统计",
    icon: "iconshouzhimingxi",
    link: "shop-stat-revenue",
    ...
    link: "shop-stat-report",
    menu: "shop-stat-report",
    roleFunc: 70
  }, {
    id: 110,
    name: "美团核销",
    icon: "iconmeituan-black",
    ...
    id: 111,
    name: "抖音核销",
    icon: "icondouyin-black",
    link: "dy-verify-coupon",
    menu: "dy-verify-coupon",
    roleFunc: 120
  }, {
    id: 112,
    name: "美团商品",
    icon: "iconmeituangoods-black",
    link: "mt-sync-bind",
    menu: "mt-sync-bind",
    roleFunc: 122
  }, {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__const__ = __webpack_require__(174);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lang__ = __webpack_require__(175);
...
const Util = {
  ...
  md5: str => {
    let crypto = __webpack_require__(430);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_router__ = __webpack_require__(718);



__WEBPACK_IMPORTED_MODULE_0_vue__["default"].use(__WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]);
const chartTest = r => __webpack_require__.e/* require.ensure */(7).then((() => r(__webpack_require__(837))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

const index = r => __webpack_require__.e/* require.ensure */(7).then((() => r(__webpack_require__(802))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const start = r => __webpack_require__.e/* require.ensure */(7).then((() => r(__webpack_require__(924))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const login = r => __webpack_require__.e/* require.ensure */(7).then((() => r(__webpack_require__(951))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const userPwdSet = r => __webpack_require__.e/* require.ensure */(7).then((() => r(__webpack_require__(953))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const userInfo = r => __webpack_require__.e/* require.ensure */(7).then((() => r(__webpack_require__(952))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const wxOauth = r => __webpack_require__.e/* require.ensure */(7).then((() => r(__webpack_require__(954))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const tenantRegister = r => __webpack_require__.e/* require.ensure */(7).then((() => r(__webpack_require__(949))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

const wxLoginForPc = r => __webpack_require__.e/* require.ensure */(7).then((() => r(__webpack_require__(958))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

//-- tenant pages
const tenantShops = r => __webpack_require__.e/* require.ensure */(17).then((() => r(__webpack_require__(950))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const tenantDetail = r => __webpack_require__.e/* require.ensure */(17).then((() => r(__webpack_require__(948))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

//-- back-stage management
const custSource = r => __webpack_require__.e/* require.ensure */(18).then((() => r(__webpack_require__(890))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const shopCardConf = r => __webpack_require__.e/* require.ensure */(18).then((() => r(__webpack_require__(891))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const shopCardEdit = r => __webpack_require__.e/* require.ensure */(6).then((() => r(__webpack_require__(892))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

//-- shop pages
const shopDetail = r => __webpack_require__.e/* require.ensure */(6).then((() => r(__webpack_require__(901))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const cardList = r => __webpack_require__.e/* require.ensure */(22).then((() => r(__webpack_require__(894))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const shopGps = r => __webpack_require__.e/* require.ensure */(6).then((() => r(__webpack_require__(904))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const shopConf = r => __webpack_require__.e/* require.ensure */(6).then((() => r(__webpack_require__(900))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const shopFeedbackList = r => __webpack_require__.e/* require.ensure */(6).then((() => r(__webpack_require__(903))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const shopEntryCheckins = r => __webpack_require__.e/* require.ensure */(6).then((() => r(__webpack_require__(902))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const shopParam = r => __webpack_require__.e/* require.ensure */(6).then((() => r(__webpack_require__(905))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const shopSmsLog = r => __webpack_require__.e/* require.ensure */(6).then((() => r(__webpack_require__(906))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const reminderConf = r => __webpack_require__.e/* require.ensure */(6).then((() => r(__webpack_require__(899))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const mtVerifyCoupon = r => __webpack_require__.e/* require.ensure */(6).then((() => r(__webpack_require__(898))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

const mtVerifyCouponList = r => __webpack_require__.e/* require.ensure */(6).then((() => r(__webpack_require__(897))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

const dyVerifyCoupon = r => __webpack_require__.e/* require.ensure */(6).then((() => r(__webpack_require__(896))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

const dyVerifyCouponList = r => __webpack_require__.e/* require.ensure */(6).then((() => r(__webpack_require__(895))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

const dySyncBind = r => __webpack_require__.e/* require.ensure */(6).then((() => r(__webpack_require__(770))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const mtSyncBind = r => __webpack_require__.e/* require.ensure */(6).then((() => r(__webpack_require__(771))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
//-- staff pages
const staffHome = r => __webpack_require__.e/* require.ensure */(1).then((() => r(__webpack_require__(916))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const coachHome = r => __webpack_require__.e/* require.ensure */(1).then((() => r(__webpack_require__(908))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const staffCreate = r => __webpack_require__.e/* require.ensure */(1).then((() => r(__webpack_require__(911))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const staffEdit = r => __webpack_require__.e/* require.ensure */(1).then((() => r(__webpack_require__(772))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const staffGroupLessons = r => __webpack_require__.e/* require.ensure */(1).then((() => r(__webpack_require__(915))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const staffGroupLessonStat = r => __webpack_require__.e/* require.ensure */(1).then((() => r(__webpack_require__(914))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const staffPcLessonStat = r => __webpack_require__.e/* require.ensure */(1).then((() => r(__webpack_require__(918))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const staffPrivateLessons = r => __webpack_require__.e/* require.ensure */(1).then((() => r(__webpack_require__(920))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const staffGcSchedules = r => __webpack_require__.e/* require.ensure */(1).then((() => r(__webpack_require__(913))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const staffPcSchedules = r => __webpack_require__.e/* require.ensure */(1).then((() => r(__webpack_require__(919))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const staffSales = r => __webpack_require__.e/* require.ensure */(1).then((() => r(__webpack_require__(922))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const staffSalary = r => __webpack_require__.e/* require.ensure */(1).then((() => r(__webpack_require__(921))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const staffList = r => __webpack_require__.e/* require.ensure */(1).then((() => r(__webpack_require__(917))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const coachWorktime = r => __webpack_require__.e/* require.ensure */(1).then((() => r(__webpack_require__(909))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const staffFuncs = r => __webpack_require__.e/* require.ensure */(1).then((() => r(__webpack_require__(912))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const coachGlCheckin = r => __webpack_require__.e/* require.ensure */(1).then((() => r(__webpack_require__(907))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const salesTargetMng = r => __webpack_require__.e/* require.ensure */(1).then((() => r(__webpack_require__(910))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const staffWorkReport = r => __webpack_require__.e/* require.ensure */(1).then((() => r(__webpack_require__(923))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

//-- course pages
const groupLessonList = r => __webpack_require__.e/* require.ensure */(4).then((() => r(__webpack_require__(780))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const groupLessonInfo = r => __webpack_require__.e/* require.ensure */(10).then((() => r(__webpack_require__(779))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const privateCourseList = r => __webpack_require__.e/* require.ensure */(4).then((() => r(__webpack_require__(787))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const privateCourseInfo = r => __webpack_require__.e/* require.ensure */(10).then((() => r(__webpack_require__(786))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const privateLessonEdit = r => __webpack_require__.e/* require.ensure */(10).then((() => r(__webpack_require__(792))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const privateLessonShare = r => __webpack_require__.e/* require.ensure */(10).then((() => r(__webpack_require__(793))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const psTrainPlanShare = r => __webpack_require__.e/* require.ensure */(10).then((() => r(__webpack_require__(795))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const groupCourseSchedules = r => __webpack_require__.e/* require.ensure */(4).then((() => r(__webpack_require__(777))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const privateCourseSchedules = r => __webpack_require__.e/* require.ensure */(4).then((() => r(__webpack_require__(789))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const privateCourseScheduleEdit = r => __webpack_require__.e/* require.ensure */(4).then((() => r(__webpack_require__(788))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const privateLessonBooking = r => __webpack_require__.e/* require.ensure */(4).then((() => r(__webpack_require__(791))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const shopPrivateLessonQuery = r => __webpack_require__.e/* require.ensure */(4).then((() => r(__webpack_require__(797))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const shopGroupLessonQuery = r => __webpack_require__.e/* require.ensure */(4).then((() => r(__webpack_require__(796))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const pcLessonCancelLog = r => __webpack_require__.e/* require.ensure */(4).then((() => r(__webpack_require__(784))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const groupLessonTable = r => __webpack_require__.e/* require.ensure */(4).then((() => r(__webpack_require__(782))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const groupLessonTableExport = r => __webpack_require__.e/* require.ensure */(4).then((() => r(__webpack_require__(781))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const psTrainPlanListShare = r => __webpack_require__.e/* require.ensure */(10).then((() => r(__webpack_require__(794))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const groupCourseScheduleEdit = r => __webpack_require__.e/* require.ensure */(4).then((() => r(__webpack_require__(776))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const lessonBookingConf = r => __webpack_require__.e/* require.ensure */(4).then((() => r(__webpack_require__(783))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const groupCourse = r => __webpack_require__.e/* require.ensure */(4).then((() => r(__webpack_require__(778))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const groupCourseEdit = r => __webpack_require__.e/* require.ensure */(4).then((() => r(__webpack_require__(775))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const privateCourse = r => __webpack_require__.e/* require.ensure */(4).then((() => r(__webpack_require__(790))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const privateCourseEdit = r => __webpack_require__.e/* require.ensure */(4).then((() => r(__webpack_require__(785))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

//-- member pages
const memberHome = r => __webpack_require__.e/* require.ensure */(2).then((() => r(__webpack_require__(862))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberQuery = r => __webpack_require__.e/* require.ensure */(5).then((() => r(__webpack_require__(874))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberBase = r => __webpack_require__.e/* require.ensure */(2).then((() => r(__webpack_require__(842))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberCardList = r => __webpack_require__.e/* require.ensure */(2).then((() => r(__webpack_require__(845))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberGroupLessons = r => __webpack_require__.e/* require.ensure */(2).then((() => r(__webpack_require__(858))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberPrivateLessons = r => __webpack_require__.e/* require.ensure */(2).then((() => r(__webpack_require__(873))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberFollows = r => __webpack_require__.e/* require.ensure */(2).then((() => r(__webpack_require__(856))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberEntryCheckins = r => __webpack_require__.e/* require.ensure */(2).then((() => r(__webpack_require__(853))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberFitnessPhoto = r => __webpack_require__.e/* require.ensure */(2).then((() => r(__webpack_require__(855))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberBodyTest = r => __webpack_require__.e/* require.ensure */(2).then((() => r(__webpack_require__(843))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberFeedbackList = r => __webpack_require__.e/* require.ensure */(2).then((() => r(__webpack_require__(854))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberPrivateLessonBooking = r => __webpack_require__.e/* require.ensure */(3).then((() => r(__webpack_require__(872))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberPlBookingByWeek = r => __webpack_require__.e/* require.ensure */(3).then((() => r(__webpack_require__(869))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberPlBookingByDay = r => __webpack_require__.e/* require.ensure */(3).then((() => r(__webpack_require__(868))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberGlCheckin = r => __webpack_require__.e/* require.ensure */(2).then((() => r(__webpack_require__(857))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberEntryCheckin = r => __webpack_require__.e/* require.ensure */(2).then((() => r(__webpack_require__(852))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberMore = r => __webpack_require__.e/* require.ensure */(3).then((() => r(__webpack_require__(866))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const myCardList = r => __webpack_require__.e/* require.ensure */(3).then((() => r(__webpack_require__(879))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const myGroupLessons = r => __webpack_require__.e/* require.ensure */(3).then((() => r(__webpack_require__(882))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const myPrivateLessons = r => __webpack_require__.e/* require.ensure */(3).then((() => r(__webpack_require__(885))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const myEntryCheckins = r => __webpack_require__.e/* require.ensure */(3).then((() => r(__webpack_require__(880))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const myPoints = r => __webpack_require__.e/* require.ensure */(3).then((() => r(__webpack_require__(884))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const myFitnessPhoto = r => __webpack_require__.e/* require.ensure */(3).then((() => r(__webpack_require__(881))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const myBodyTest = r => __webpack_require__.e/* require.ensure */(3).then((() => r(__webpack_require__(878))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const myHrs = r => __webpack_require__.e/* require.ensure */(3).then((() => r(__webpack_require__(883))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const myRun = r => __webpack_require__.e/* require.ensure */(3).then((() => r(__webpack_require__(886))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberCardSale = r => __webpack_require__.e/* require.ensure */(3).then((() => r(__webpack_require__(847))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberPlCheckin = r => __webpack_require__.e/* require.ensure */(3).then((() => r(__webpack_require__(871))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberPlCheckinListToday = r => __webpack_require__.e/* require.ensure */(3).then((() => r(__webpack_require__(870))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberScoreTestRank = r => __webpack_require__.e/* require.ensure */(2).then((() => r(__webpack_require__(875))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberPhotoShare = r => __webpack_require__.e/* require.ensure */(2).then((() => r(__webpack_require__(867))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberCreate = r => __webpack_require__.e/* require.ensure */(5).then((() => r(__webpack_require__(849))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberDraftEdit = r => __webpack_require__.e/* require.ensure */(5).then((() => r(__webpack_require__(850))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberDraftQuery = r => __webpack_require__.e/* require.ensure */(5).then((() => r(__webpack_require__(851))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberCardDraftQuery = r => __webpack_require__.e/* require.ensure */(5).then((() => r(__webpack_require__(844))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberCardQuery = r => __webpack_require__.e/* require.ensure */(5).then((() => r(__webpack_require__(846))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberActionQuery = r => __webpack_require__.e/* require.ensure */(5).then((() => r(__webpack_require__(839))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberInfo = r => __webpack_require__.e/* require.ensure */(2).then((() => r(__webpack_require__(864))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const changeSkin = r => __webpack_require__.e/* require.ensure */(2).then((() => r(__webpack_require__(946))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const test = r => __webpack_require__.e/* require.ensure */(7).then((() => r(__webpack_require__(887))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberTestType = r => __webpack_require__.e/* require.ensure */(5).then((() => r(__webpack_require__(877))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberComprehensiveScore = r => __webpack_require__.e/* require.ensure */(5).then((() => r(__webpack_require__(848))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberTestScore = r => __webpack_require__.e/* require.ensure */(5).then((() => r(__webpack_require__(876))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberHrs = r => __webpack_require__.e/* require.ensure */(5).then((() => r(__webpack_require__(863))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

const memberHealthReport = r => __webpack_require__.e/* require.ensure */(5).then((() => r(__webpack_require__(860))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

const memberAnnualReport = r => __webpack_require__.e/* require.ensure */(21).then((() => r(__webpack_require__(840))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberHeartRateRank = r => __webpack_require__.e/* require.ensure */(2).then((() => r(__webpack_require__(861))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberAutoRenew = r => __webpack_require__.e/* require.ensure */(3).then((() => r(__webpack_require__(841))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const rechargeCard = r => __webpack_require__.e/* require.ensure */(23).then((() => r(__webpack_require__(833))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberLabelSetting = r => __webpack_require__.e/* require.ensure */(5).then((() => r(__webpack_require__(865))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

//-- mach pages
const loginForImstlife = r => __webpack_require__.e/* require.ensure */(12).then((() => r(__webpack_require__(809))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const lockerForImstlife = r => __webpack_require__.e/* require.ensure */(12).then((() => r(__webpack_require__(808))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const bathroomForImstlife = r => __webpack_require__.e/* require.ensure */(25).then((() => r(__webpack_require__(805))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const hrsBindForImstlife = r => __webpack_require__.e/* require.ensure */(11).then((() => r(__webpack_require__(807))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const hrsBindCustForImstlife = r => __webpack_require__.e/* require.ensure */(11).then((() => r(__webpack_require__(806))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const runBindForImstlife = r => __webpack_require__.e/* require.ensure */(11).then((() => r(__webpack_require__(812))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const runBindCustForImstlife = r => __webpack_require__.e/* require.ensure */(11).then((() => r(__webpack_require__(811))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const userHrsForShare = r => __webpack_require__.e/* require.ensure */(11).then((() => r(__webpack_require__(888))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const userRunForShare = r => __webpack_require__.e/* require.ensure */(11).then((() => r(__webpack_require__(889))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const authUserForImstlife = r => __webpack_require__.e/* require.ensure */(12).then((() => r(__webpack_require__(804))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const shopHrs = r => __webpack_require__.e/* require.ensure */(12).then((() => r(__webpack_require__(813))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const qrcodeMachCheckin = r => __webpack_require__.e/* require.ensure */(12).then((() => r(__webpack_require__(810))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const venueAreaBookingCheckout = r => __webpack_require__.e/* require.ensure */(24).then((() => r(__webpack_require__(814))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const aiMachEntrance = r => __webpack_require__.e/* require.ensure */(12).then((() => r(__webpack_require__(803))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

//-- stat pages
const statHome = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(929))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const statMember = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(938))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const statMemberEntry = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(931))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const statMemberPoints = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(935))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const statMemberLesson = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(932))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const statMemberPayment = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(934))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const statMemberSource = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(937))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const statSales = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(944))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const statGroupCoach = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(927))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const statPrivateCoach = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(939))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const statGroupCourse = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(928))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const statPrivateCourse = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(940))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const statCard = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(925))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const statRevenue = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(942))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const statReport = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(941))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const statMemberMore = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(933))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const statMemberPrivateLesson = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(936))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const statMemberCheckinDays = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(930))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const statSalesTarget = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(943))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const statDataReport = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(926))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

//-- cust pages
const custQuery = r => __webpack_require__.e/* require.ensure */(13).then((() => r(__webpack_require__(800))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const custEdit = r => __webpack_require__.e/* require.ensure */(13).then((() => r(__webpack_require__(798))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const visitCustByDay = r => __webpack_require__.e/* require.ensure */(13).then((() => r(__webpack_require__(801))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const custFollowTask = r => __webpack_require__.e/* require.ensure */(13).then((() => r(__webpack_require__(799))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

//-- sys pages
const aboutUs = r => __webpack_require__.e/* require.ensure */(19).then((() => r(__webpack_require__(945))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const menuSetting = r => __webpack_require__.e/* require.ensure */(19).then((() => r(__webpack_require__(947))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

//-- market pages
const msiteIntro = r => __webpack_require__.e/* require.ensure */(9).then((() => r(__webpack_require__(832))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const couponList = r => __webpack_require__.e/* require.ensure */(9).then((() => r(__webpack_require__(822))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const couponCreate = r => __webpack_require__.e/* require.ensure */(9).then((() => r(__webpack_require__(821))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const lotteryList = r => __webpack_require__.e/* require.ensure */(9).then((() => r(__webpack_require__(831))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const lotteryCreate = r => __webpack_require__.e/* require.ensure */(9).then((() => r(__webpack_require__(830))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const groupbuy = r => __webpack_require__.e/* require.ensure */(9).then((() => r(__webpack_require__(829))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const bargain = r => __webpack_require__.e/* require.ensure */(9).then((() => r(__webpack_require__(820))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const seckill = r => __webpack_require__.e/* require.ensure */(9).then((() => r(__webpack_require__(834))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const shareItemList = r => __webpack_require__.e/* require.ensure */(8).then((() => r(__webpack_require__(835))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const shareItemPage = r => __webpack_require__.e/* require.ensure */(8).then((() => r(__webpack_require__(769))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const shareItemReceiver = r => __webpack_require__.e/* require.ensure */(8).then((() => r(__webpack_require__(836))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const eventDetail = r => __webpack_require__.e/* require.ensure */(8).then((() => r(__webpack_require__(824))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const eventList = r => __webpack_require__.e/* require.ensure */(8).then((() => r(__webpack_require__(826))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const eventCheckStatistics = r => __webpack_require__.e/* require.ensure */(8).then((() => r(__webpack_require__(823))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const eventEnrollList = r => __webpack_require__.e/* require.ensure */(8).then((() => r(__webpack_require__(825))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const eventPoster = r => __webpack_require__.e/* require.ensure */(8).then((() => r(__webpack_require__(828))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const eventPosterEdit = r => __webpack_require__.e/* require.ensure */(8).then((() => r(__webpack_require__(827))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

//-- mall pages
const mallProductList = r => __webpack_require__.e/* require.ensure */(20).then((() => r(__webpack_require__(816))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const mallProduct = r => __webpack_require__.e/* require.ensure */(20).then((() => r(__webpack_require__(818))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const mallShoppingCart = r => __webpack_require__.e/* require.ensure */(15).then((() => r(__webpack_require__(819))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const mallProductPay = r => __webpack_require__.e/* require.ensure */(15).then((() => r(__webpack_require__(817))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberMallOrder = r => __webpack_require__.e/* require.ensure */(15).then((() => r(__webpack_require__(815))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

//-- venue pages
const venueBooking = r => __webpack_require__.e/* require.ensure */(14).then((() => r(__webpack_require__(957))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const venueBooking1 = r => __webpack_require__.e/* require.ensure */(14).then((() => r(__webpack_require__(956))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberVenueBookings = r => __webpack_require__.e/* require.ensure */(14).then((() => r(__webpack_require__(955))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
...
const router = new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
  ...
  //-- back-stage management
  {
    ...
    meta: { ignoreAuth: true }
  }, { path: '/wx-login-for-pc', component: wxLoginForPc, meta: { ignoreAuth: true } }, { path: "/cust-source", component: custSource, meta: { roleFunc: 27 } }, { path: "/shop-card-conf", component: shopCardConf, meta: {} }, {
  ...
  { path: "/member-more", component: memberMore, meta: { pageType: 3 } }, { path: "/member-home", component: memberHome, meta: { pageType: 3 } }, { path: "/member-query", component: memberQuery, meta: { pageType: 2 } }, {
    ...
    path: "/health-report/:btId",
    component: r => __webpack_require__.e/* require.ensure */(5).then((() => r(__webpack_require__(838))).bind(null, __webpack_require__)).catch(__webpack_require__.oe)
  }, {
    path: "/member-health-report-list",
    component: r => __webpack_require__.e/* require.ensure */(5).then((() => r(__webpack_require__(859))).bind(null, __webpack_require__)).catch(__webpack_require__.oe)
  }, { path: "/mt-verify-coupon", component: mtVerifyCoupon }, { path: "/mt-verify-coupon-list", component: mtVerifyCouponList }, { path: "/dy-verify-coupon", component: dyVerifyCoupon }, { path: "/dy-verify-coupon-list", component: dyVerifyCouponList }, { path: "/mt-sync-bind", component: mtSyncBind, meta: { roleFunc: 122 } }, { path: "/dy-sync-bind", component: dySyncBind, meta: { roleFunc: 123 } }, { path: "/member-annual-report", component: memberAnnualReport }, { path: "/member-heart-rate-rank", component: memberHeartRateRank },
  ...
  {
    path: "/test-select",
    component: r => __webpack_require__.e/* require.ensure */(16).then((() => r(__webpack_require__(773))).bind(null, __webpack_require__)).catch(__webpack_require__.oe)
  }, {
    path: "/test-table",
    component: r => __webpack_require__.e/* require.ensure */(16).then((() => r(__webpack_require__(774))).bind(null, __webpack_require__)).catch(__webpack_require__.oe)
  }, {
    path: "*",
    component: r => __webpack_require__.e/* require.ensure */(26).then((() => r(__webpack_require__(893))).bind(null, __webpack_require__)).catch(__webpack_require__.oe)
  }],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_debounce__ = __webpack_require__(580);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_debounce___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_lodash_debounce__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_resize_detector__ = __webpack_require__(601);
//
//
//
//
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vconsole__ = __webpack_require__(701);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function () {
    ...
    // });
    let theme = 1;
    __webpack_require__(751)("./theme" + theme + ".css");
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	data() {
		return {
			...
			mobileMenusDict: {
				...
				12: {
					menu: "member-points-rank",
					name: "积分排名",
					icon: "iconceshipaihangbang",
					link: "member-points-rank"
				},
				13: {
					menu: "member-hr-rank",
					name: "心率排名",
					icon: "icon-heartrate-yel",
					link: "member-heart-rate-rank"
				},
				99: {
					menu: "my",
	...
	created() {
		this.staffDefineMenuList.forEach(item => {
			item.title = null;
		});
		if (this.u.memberId) {
	...
	methods: {
		...
		resetBottomMenu(param) {
			...
			param.forEach(item => {
				...
				// 自定义的首页名称
				if (arr1[0] == 101) {
					this.custom.home = arr1[1];
					return;
				}
				// 自定义的更多名称
				if (arr1[0] == 102) {
					this.custom.more = arr1[1];
					return;
				}
				let menuMap;
				if (arr1.length && arr2.length < 2) {
					let list = this.staffDefineMenuList.find(c => c.id == arr1[0]);
					menuMap = Object.assign({}, list);
					if (arr1[1]) {
						menuMap.title = arr1[1];
					}
				}
				if (arr2.length > 1) {
					const obj = {
					...
					arr2.forEach((cItem, idx) => {
						let arr3 = cItem.split(":");
						if (idx !== 0) {
							let list = this.staffDefineMenuList.find(c => c.id == arr3[0]);
							if (arr3[1]) {
								list.title = arr3[1];
							}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__select_functional_options_vue__ = __webpack_require__(703);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__select_functional_options_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__select_functional_options_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: "qdSelect",
  components: { FunctionalOptions: __WEBPACK_IMPORTED_MODULE_0__select_functional_options_vue___default.a },
  props: {
    value: {
...
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__router__ = __webpack_require__(339);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__assets_js_syslib_js__ = __webpack_require__(338);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__assets_js_bizlib_js__ = __webpack_require__(337);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__assets_js_const_js__ = __webpack_require__(174);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__assets_js_lang_js__ = __webpack_require__(175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_muse_ui__ = __webpack_require__(354);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_muse_ui_dist_muse_ui_css__ = __webpack_require__(348);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_muse_ui_dist_theme_light_css__ = __webpack_require__(349);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_cropperjs_dist_cropper_css__ = __webpack_require__(347);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_vant__ = __webpack_require__(285);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_select_vue__ = __webpack_require__(179);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_select_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11__components_select_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_option_vue__ = __webpack_require__(178);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_option_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12__components_option_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__assets_css_common_css__ = __webpack_require__(352);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_vant_lib_dialog_index_css__ = __webpack_require__(351);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15_vant_lib_datetime_picker_style_index__ = __webpack_require__(357);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_vant_lib_notify_style_index__ = __webpack_require__(358);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_vant_lib_uploader_style_index__ = __webpack_require__(365);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18_vant_lib_switch_cell_style_index__ = __webpack_require__(361);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19_vant_lib_switch_style_index__ = __webpack_require__(362);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20_vant_lib_tab_style_index__ = __webpack_require__(363);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21_vant_lib_tabs_style_index__ = __webpack_require__(364);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22_vant_lib_rate_style_index__ = __webpack_require__(360);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23_vant_lib_checkbox_style_index__ = __webpack_require__(356);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24_vant_lib_checkbox_group_style_index__ = __webpack_require__(355);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25_vant_lib_popover_style_index__ = __webpack_require__(359);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25_vant_lib_popover_style_index___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_25_vant_lib_popover_style_index__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__components_bottom_nav_vue__ = __webpack_require__(311);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__components_bottom_nav_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_26__components_bottom_nav_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__components_Tab_vue__ = __webpack_require__(369);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__components_Tab_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_27__components_Tab_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__components_page_head_vue__ = __webpack_require__(312);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__components_page_head_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_28__components_page_head_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__components_pagination_vue__ = __webpack_require__(370);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__components_pagination_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_29__components_pagination_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__components_pull_down_list_vue__ = __webpack_require__(176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__components_pull_down_list_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_30__components_pull_down_list_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__components_monthDayPicker_vue__ = __webpack_require__(177);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__components_monthDayPicker_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_31__components_monthDayPicker_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__components_qd_switch_vue__ = __webpack_require__(313);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__components_qd_switch_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_32__components_qd_switch_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__components_qd_checkbox_vue__ = __webpack_require__(371);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__components_qd_checkbox_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_33__components_qd_checkbox_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34_vue_echarts_components_ECharts_vue__ = __webpack_require__(367);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34_vue_echarts_components_ECharts_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_34_vue_echarts_components_ECharts_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35_echarts_lib_chart_bar__ = __webpack_require__(340);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35_echarts_lib_chart_bar___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_35_echarts_lib_chart_bar__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36_echarts_lib_chart_line__ = __webpack_require__(341);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36_echarts_lib_chart_line___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_36_echarts_lib_chart_line__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37_echarts_lib_chart_pie__ = __webpack_require__(342);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37_echarts_lib_chart_pie___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_37_echarts_lib_chart_pie__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38_echarts_lib_chart_themeRiver__ = __webpack_require__(211);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38_echarts_lib_chart_themeRiver___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_38_echarts_lib_chart_themeRiver__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39_echarts_lib_component_tooltip__ = __webpack_require__(345);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39_echarts_lib_component_tooltip___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_39_echarts_lib_component_tooltip__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40_echarts_lib_component_legend__ = __webpack_require__(344);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40_echarts_lib_component_legend___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_40_echarts_lib_component_legend__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41_echarts_lib_component_visualMap__ = __webpack_require__(346);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41_echarts_lib_component_visualMap___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_41_echarts_lib_component_visualMap__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42_echarts_lib_component_grid__ = __webpack_require__(343);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42_echarts_lib_component_grid___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_42_echarts_lib_component_grid__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__components_sys_input_int_vue__ = __webpack_require__(372);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__components_sys_input_int_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_43__components_sys_input_int_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__components_sys_input_num_vue__ = __webpack_require__(373);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__components_sys_input_num_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_44__components_sys_input_num_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45_img_vuer__ = __webpack_require__(353);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45_img_vuer___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_45_img_vuer__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_46_vue_awesome_swiper__ = __webpack_require__(366);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_46_vue_awesome_swiper___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_46_vue_awesome_swiper__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47_swiper_dist_css_swiper_css__ = __webpack_require__(350);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47_swiper_dist_css_swiper_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_47_swiper_dist_css_swiper_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_48__App__ = __webpack_require__(368);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_48__App___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_48__App__);
...
window.onload = function () {
  ...
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].use(__WEBPACK_IMPORTED_MODULE_46_vue_awesome_swiper___default.a);
  // Vue.use(Vant)
  ...
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].use(__WEBPACK_IMPORTED_MODULE_10_vant__["s" /* Popover */]);
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].config.productionTip = false;
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].config.devtools = false;
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].component("bottom-nav", __WEBPACK_IMPORTED_MODULE_26__components_bottom_nav_vue___default.a);
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].component("tab", __WEBPACK_IMPORTED_MODULE_27__components_Tab_vue___default.a);
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].component("page-head", __WEBPACK_IMPORTED_MODULE_28__components_page_head_vue___default.a);
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].component("pagination", __WEBPACK_IMPORTED_MODULE_29__components_pagination_vue___default.a);
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].component("month-day-picker", __WEBPACK_IMPORTED_MODULE_31__components_monthDayPicker_vue___default.a);
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].component("pullDownList", __WEBPACK_IMPORTED_MODULE_30__components_pull_down_list_vue___default.a);
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].component("qd-switch", __WEBPACK_IMPORTED_MODULE_32__components_qd_switch_vue___default.a);
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].component("qd-checkbox", __WEBPACK_IMPORTED_MODULE_33__components_qd_checkbox_vue___default.a);
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].component("chart", __WEBPACK_IMPORTED_MODULE_34_vue_echarts_components_ECharts_vue___default.a);
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].use(__webpack_require__(374));
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].component("input-int", __WEBPACK_IMPORTED_MODULE_43__components_sys_input_int_vue___default.a);
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].component("input-num", __WEBPACK_IMPORTED_MODULE_44__components_sys_input_num_vue___default.a);
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].component("qd-option", __WEBPACK_IMPORTED_MODULE_12__components_option_vue___default.a);
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].component("qd-select", __WEBPACK_IMPORTED_MODULE_11__components_select_vue___default.a);
  __WEBPACK_IMPORTED_MODULE_0_vue__["default"].use(__WEBPACK_IMPORTED_MODULE_45_img_vuer___default.a, {
  ...
  _loading_(function () {
    ...
    const vue = new __WEBPACK_IMPORTED_MODULE_0_vue__["default"]({
      ...
      template: "<App/>",
      components: { App: __WEBPACK_IMPORTED_MODULE_48__App___default.a }
    });
    window.$.Dlg.vue = vue;
  });
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [(_vm.g.data.user.memberId && _vm.showSlogan) ? _c('div', {
    ...
    staticClass: "name"
  }, [_vm._v(_vm._s(_vm.custom.home || '首页'))])]), _vm._v(" "), _vm._l((_vm.staffMobileMenusArr), function(c, idx) {
    return [(!c.isChildList && c && c.id) ? [(_vm.isShopOwner || !c.roleFunc || (_vm.u.roleFuncList.contains(c.roleFunc))) ? _c('router-link', {
      key: idx,
      class: {
      ...
      staticClass: "name"
    }, [_vm._v(_vm._s(c.title || c.name))])]) : _vm._e()] : _c('div', [_c('van-popover', {
      attrs: {
        "placement": "top",
        "trigger": "click"
      },
      ...
      model: {
        value: (c.showPopover),
        callback: function($$v) {
          _vm.$set(c, "showPopover", $$v)
        },
        expression: "c.showPopover"
      }
    }, [_c('div', {
      staticClass: "popover-menu"
    }, [_vm._l((c.children), function(i, cIdx) {
      return [(_vm.isShopOwner || !i.roleFunc || (_vm.u.roleFuncList.contains(i.roleFunc))) ? _c('router-link', {
        key: cIdx,
        class: {
          'theme-font-color': _vm.menu && _vm.menu === i.menu
        },
        attrs: {
          "to": ('/' + i.link) + (i.requireStaffId ? ('/' + _vm.staffId) : '')
        }
      }, [_c('i', {
        class: 'iconfont ' + i.icon
      }), _vm._v(" "), _c('div', {
        staticClass: "name"
      }, [_vm._v(_vm._s(i.title || i.name))])]) : _vm._e()]
    })], 2)])], 1)]
    ...
    staticClass: "name"
  }, [_vm._v(_vm._s(_vm.custom.more || '更多'))])])] : [(_vm.u.isShopOwner) ? [_c('router-link', {
    class: {
      'theme-font-color': _vm.menu == 'home'
    },
    attrs: {
    ...
    staticClass: "name"
  }, [_vm._v(_vm._s(_vm.custom.home || '首页'))])]), _vm._v(" "), (_vm.u.isPrivateCoach && _vm.g.data.shop.hasPrivateCourse) ? _c('router-link', {
    class: {
    ...
    staticClass: "name"
  }, [_vm._v(_vm._s(_vm.custom.more || '更多'))])])] : (_vm.u.isCoach) ? [_c('router-link', {
    class: {
      'theme-font-color': _vm.menu == 'home'
    },
    attrs: {
    ...
    staticClass: "name"
  }, [_vm._v(_vm._s(_vm.custom.more || '更多'))])])] : [_c('router-link', {
    class: {
      'theme-font-color': _vm.menu == 'home'
    },
    attrs: {
    ...
    staticClass: "name"
  }, [_vm._v(_vm._s(_vm.custom.more || '更多'))])])]]]], 2)])])
},staticRenderFns: []}
